	...
	<div className="mx-auto">
		<div className="flex justify-center px-6 py-12">
			...
			<div className="w-full xl:w-3/4 lg:w-11/12 flex">
				{/* <!-- Col --> */}
				<div className="bg-[url('https://industryeurope.com/downloads/9015/download/shutterstock_465653942.jpg?cb=c16922ab57b31a873d650a7d2cfaf5f9&w=1200')] bg-center w-full h-auto bg-gray-400 dark:bg-gray-800 hidden lg:block lg:w-5/12 bg-cover rounded-l-lg"
